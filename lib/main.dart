  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => EventReportBloc(EventReportRepository())),
        ...
        BlocProvider(create: (_) => ViewScoreBloc(ViewScoreRepository())),
        BlocProvider(
          create: (_) => UpdateProfileBloc(UpdateProfileRepository()),
          child: MyProfile(),
        ),
        BlocProvider(create: (_) => EventDetailsBloc(EventDetailsRepository())),
        BlocProvider(create: (_) => PaymentBloc(PaymentRepository())),
        BlocProvider(
          create: (_) => PaymentAfterSuccessBloc(PaymentAfterSuccess()),
        ),
